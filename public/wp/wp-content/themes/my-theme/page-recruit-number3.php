	...
	<img src="/assets/img/number/item_001_pc.png" alt="週2日在宅勤務、週3日出社">
		...
		<div class="unit fadein">
			...
			<div class="body flex fadein">
				...
				<div class="img"><img src="/assets/img/number/item_002_03.png" alt="従業員数推移 2022年 45名"></div>
		...
		<div class="unit fadein">
			...
			<div class="body flex fadein">
				...
				<div class="img"><img src="/assets/img/number/item_004_03.png?202306270651" alt="平均年齢 37.5歳"></div>
	...
	<div class="flex col3">
		...
		<div class="unit fadein">
			...
			<div class="body flex center fadein">
				...
				<div class="count">
					<span class="count-num" data-to="71">0</span><span class="count-unit">%</span>
				</div>
			</div><!-- .body -->
		</div><!-- .unit -->
	...
	<div class="section-wrapper"><div class="section-frame large">
		...
		<div class="unit fadein">
			...
			<div class="body flex fadein">
				...
				<div class="img"><img src="/assets/img/number/item_005_03.png" alt="男女比率 男性社員32名 女性社員21名"></div>

			</div><!-- .body -->
		</div><!-- .unit -->

		<div class="unit fadein">
			<div class="head fadein">インドア派？アウトドア派？</div>
			<div class="body flex fadein">

				<div class="img"><img src="/assets/img/number/item_007_03.png?202306222208" alt=""></div>

			</div><!-- .body -->
		</div><!-- .unit -->

		<div class="unit fadein">
			<div class="head fadein">犬派？猫派？</div>
			<div class="body flex fadein">

				<div class="img"><img src="/assets/img/number/item_008_02.png?202306222208" alt=""></div>

			</div><!-- .body -->
		</div><!-- .unit -->

		<div class="unit fadein">
			<div class="head fadein">スマホはiPhone派？ Android派？</div>
			<div class="body flex fadein">

				<div class="img"><img src="/assets/img/number/item_009_02.png?202306222208" alt=""></div>

			</div><!-- .body -->
		</div><!-- .unit -->

		<div class="unit fadein">
			<div class="head fadein">和食派？洋食派？</div>
			<div class="body flex fadein">

				<div class="img"><img src="/assets/img/number/item_010_02.png?202306280649" alt=""></div>

			</div><!-- .body -->
		</div><!-- .unit -->

		<div class="unit fadein">
			<div class="head fadein">好きなカイクラのシステムは？</div>
			<div class="body flex fadein">

				<div class="img"><img src="/assets/img/number/item_011_02.png" alt=""></div>
