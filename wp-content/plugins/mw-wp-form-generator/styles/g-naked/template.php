<?php
/**
 * MW_WP_Form_Generator_Template_G_Naked
 * Version    : 1.1.0
 ...
 */
class MW_WP_Form_Generator_Template_G_Naked extends MW_WP_Form_Generator_Template_Base {
	...
	public function create_content( $content, $items, $other_items ) {
		...
		foreach ( $items as $item ) {
			...
			if ( $item['description'] ) {
				$description = sprintf(
					'<div class="g-naked-description">%s</div>',
...
new MW_WP_Form_Generator_Template_G_Naked();
